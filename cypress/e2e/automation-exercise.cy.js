...
describe("Casos de teste do site Automation Exercise ", () => {
  ...
  it("Test Case 1: Register User", () => {
    ...
    cadastro.preencherInformacoesCadastro(
      randomFirstName,
      randomLastName,
      randomCompanyName,
      randomAddress,
  ...
  it("Test Case 3: Login User with incorrect email and password", () => {
    ...
    cy.get(locator.label_senha_incorreta).should(
      "contain",
  ...
  it("Test Case 5: Register User with existing email", () => {
    ...
    cy.get(locator.label_email_existente).should(
      "contain",
  ...
  it("Test Case 6: Contact Us Form", () => {
    ...
    cy.get(locator.sucesso_contato_form).should(
      "have.text",
  ...
  it("Test Case 15: Place Order: Register before Checkout", () => {
    ...
    login
      .preencherCadastro(randomFullName, randomEmail)
      .preencherInformacoesCadastro(
        randomFirstName,
        randomLastName,
        randomCompanyName,
        randomAddress,
    ...
    pagamento.preencherInfoPagamento(
      randomCardName,
      randomCardNumber,
      randomCardCVC,
    );

    cy.get(locator.label_confirma_compra).should(
      "have.text",
